...
class StanleyController():
    ...
    def get_commands(self,waypoints,x,y,yaw,v):
        ...
        for i in range(waypoints):
            distance_to_waypoint[i] = (front_axle_x - waypoints[i][0])**2 + (front_axle_y - waypoints[i][1])**2
            nearest_waypoint_index = min(distance_to_waypoint)
        ...
        crosstrack_error = -([0]*crosstrack_vector[1] - \
